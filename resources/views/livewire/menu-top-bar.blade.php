<div >
    ...
    <ul class="nav" id="topbar">
        ...
        <li class="nav-item dropdowm {{Route::currentRouteName() == 'registrar' || Route::currentRouteName() == 'registro_manual' ? 'active' : ''}}">
          <a class="nav-link  dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button" aria-expanded="false">Registrar</a>
