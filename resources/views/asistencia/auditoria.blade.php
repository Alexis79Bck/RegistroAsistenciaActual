                                        ...
                                        <div class="accordion-item">
                                            <h2 class="accordion-header" id="headingOne">
                                                <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                                    data-bs-target="#acc-{{ $empleadosPorDepto[$i][$j]['cedula'] }}"
                                                    aria-expanded="true"
                                                    aria-controls="acc-{{ $empleadosPorDepto[$i][$j]['cedula'] }}">
                                                    <span>{{ $empleadosPorDepto[$i][$j]['nombreCompleto'] }}</span>
                                                </button>
                                            </h2>

                                            <div id="acc-{{ $empleadosPorDepto[$i][$j]['cedula'] }}"
                                                class="accordion-collapse collapse "
                                                aria-labelledby="{{ $empleadosPorDepto[$i][$j]['cedula'] }}"
                                                data-bs-parent="#acordeonAudit">
                                                <div class="accordion-body">
                                                    <table class="table table-striped">
                                                        <thead>
                                                            <tr>
                                                                <th>
                                                                    <p class="fs-5 fw-bold">Fecha</p>
                                                                </th>
                                                                <th>
                                                                    <p class="fs-5 fw-bold">Hora</p>
                                                                </th>
                                                                <th>
                                                                    <p class="fs-5 fw-bold">Acceso Por</p>
                                                                </th>
                                                                <th>
                                                                    <p class="fs-5 fw-bold">Acción</p>
                                                                </th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                    ...
                                    @if ($departamento[$i]->nombre == $info[$i][$j]['departamento'])
                                        <tr>
                                            ...
                                            <td data-label="Hora Entrada">
                                                ...
                                                @else
                                                    @if ($info[$i][$j]['Nocturno'])
                                                        <span class="fw-bold h4 fs-6 text-danger">
                                                            {{ $info[$i][$j]['horaEnt'] }}</span>
                                                    @else
                                                        {{ $info[$i][$j]['horaEnt'] }}
                                                    @endif
                                                @endif
                                ...
                                @if ($lstFecha[$k] == $info[$j]['fecha'])
                                    <tr>
                                        ...
                                        <td data-label="Hora Salida">
                                            ...
                                            @else
                                                @if ($info[$j]['Nocturno'])
                                                    <span class="fw-bold h4 fs-6 text-danger">({{ $info[$j]['fechaSal'] }})
                                                        {{ $info[$j]['horaSal'] }}</span>
                                                @else
                                                    {{ $info[$j]['horaSal'] }}
                                                @endif
